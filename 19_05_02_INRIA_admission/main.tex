...
\]
\only<1>{
{\large \bf Algorithmes existants:}\\
\begin{itemize}
    \item Iterative Soft-Thresholding Algorithm (ISTA)\\\mycite{Chalasani2013}
    \item Alternated Direction Method of Multiplier\\\mycite{Bristow2013}
...
%        \myitem{} Passe à l'échelle \textbf{super-linéairement}
%        \vskip.2em
%    \end{block}
}
%
\only<4>{
    \centering \textcolor{linkcolor}{preprint 2019}: Extension pour signaux 2D\\
    \vspace{0pt plus 1 filll}
    \includegraphics[height=.8em]{github}~\textbf{DiCoDiLe}
    : \url{github.com/tommoral/dicodile}\\
}

\end{frame}


%\begin{frame}[t]{DICOD: un algorithme asynchrone distribuée%
%              \keypoint{ICML, 2018}}
