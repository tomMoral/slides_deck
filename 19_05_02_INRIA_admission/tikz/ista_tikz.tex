...
\draw ($ (h.center) + (.2em,0em)  $) -- ($ (h.center) + (.8em,.7em)  $);
\node[right=2.5em of h] (Z) {$Z^*$};
\path (add.east)
edge[pil] (h.west);
\path (h.east)
edge[pil] (Z);
\node[inner sep=0,minimum size=0,right=1.5em of h] (branch) {};
\node[varstyle,below=.5em of h, text width=3em,] (S) {\small $I - F^\top F$};
