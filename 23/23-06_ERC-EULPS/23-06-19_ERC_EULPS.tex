...
\frame{
    ...
    {\bf Idea:} use Point Processes to model the events' distribution $\mathbb P(\{t_k\}_k)$.
    ...
    \begin{columns}[T]
        ...
        \vskip.5em
        \centering
        \includegraphics[width=\textwidth]{connectivity_default_mode}\\[-1em]
        \small Spatial events interactions\\in the brain
    \end{columns}

    \vskip.5em
    {\bf Development:} Parametric models beyond Markovian kernels to capture  complex events' dependencies and uncertainty in space and time.
    % \myitem{} General Parametric Family for temporal, marked and spatial PP.

    \vskip1em
    {\bf Preliminary Study:} \fakecite{Staerman, Allain, Gramfort \& {\bf M.} ICML 2023}
