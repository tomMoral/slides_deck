...
\begin{itemize}
	\item The data \textbf{scale, conditionning}
	\item The objective parameters \textbf{regularisation}
	\item The implementation \textbf{complexity, language}
\end{itemize}
\end{minipage}
...
\frame{
    \frametitle{BenchOpt: list of problem}

    \begin{columns}
        \column{.5\textwidth}
        {\centering
        \includegraphics[]{list_problem}\\
        }
        \column{.5\textwidth}
