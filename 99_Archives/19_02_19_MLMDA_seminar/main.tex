...
\begin{frame}{Distributed Convolutional Dictionary Learning (DiCoDiLe-Z)\\\mycite{Moreau2019}}
...
\begin{columns}[c]
    ...
    \column{.5\textwidth}
    \begin{itemize}[<+->]\itemsep1em
        \item DICOD does not work for splits in dimension $> 1$.
